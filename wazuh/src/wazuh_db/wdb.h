...
typedef enum wdb_stmt {
    ...
    //added by wenqin
    WDB_STMT_ACCOUNT_INSERT,
    WDB_STMT_ACCOUNT_DEL,
    ...
    WDB_STMT_DEVINFO_INSERT,
    WDB_STMT_DEVINFO_DEL,
...
int wdb_account_insert(wdb_t * wdb, const char * scan_id, const char * scan_time,
                       ...
                       const char * password, const char * weak_password, const char * last_login_ip, const char * last_login_time);
