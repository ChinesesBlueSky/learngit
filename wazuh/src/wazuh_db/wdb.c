...
static const char *SQL_STMT[] = {
    ...
    //added by wenqin    
    [WDB_STMT_ACCOUNT_INSERT] = "INSERT INTO sys_accounts (scan_id, scan_time, user_name, user_id, group_id, user_info, home_dir, shell_program, password, weak_password, last_login_ip, last_login_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
    [WDB_STMT_ACCOUNT_DEL] = "DELETE FROM sys_accounts WHERE scan_id != ?;",
    ...
    [WDB_STMT_DEVINFO_INSERT] = "INSERT INTO sys_device (scan_id, scan_time, dev_type, dev_id, dev_name) VALUES (?, ?, ?, ?, ?);",
    [WDB_STMT_DEVINFO_DEL] = "DELETE FROM sys_device WHERE scan_id != ?;",
};
