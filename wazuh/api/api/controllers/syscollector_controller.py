...
async def get_accounts_info(request, agent_id, pretty=False, wait_for_complete=False, offset=0, limit=None, select=None,
                            sort=None, search=None, user_name=None, weak_password=None, q=None):
    """ Get accounts info of an agent
    ...
    ascending or descending order.
    :param search: Looks for elements with the specified string
    :param user_name: Filters by user_name
    :param weak_password: Filters by weak_password
    :param q: Query to filter results by.
    :return: Data
    """
...
async def get_devices_info(request, agent_id, pretty=False, wait_for_complete=False, offset=0, limit=None, select=None,
                           sort=None, search=None, dev_type=None, q=None):
    """ Get devices info of an agent
