...
def get_valid_fields(element_type, agent_id=None):
    ...
    valid_select_fields = {
        ...
        Type.DEVICES: ('sys_device', {'scan_id': 'scan_id', 'scan_time': 'scan_time', 'dev_type': 'dev_type', 'dev_id': 'dev_id', 'dev_name': 'dev_name'}),
        
        Type.ACCOUNTS: ('sys_accounts', {'scan_id': 'scan_id', 'scan_time': 'scan_time', 'user_name': 'user_name',
                                         'user_id': 'user_id', 'group_id': 'group_id', 'user_info': 'user_info',
                                         'home_dir': 'home_dir', 'shell_program': 'shell_program',
                                         'password': 'password', 'weak_password': 'weak_password',
                                         'last_login_ip': 'last_login_ip', 'last_login_time': 'last_login_time'})
    }
